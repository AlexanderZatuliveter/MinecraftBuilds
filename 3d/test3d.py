...
mesh = trimesh.load("C:\\Data\\Code\\Personal\\Minecraft\\3d\\glad3Dprintable-animal-octopus.STL")
print('loaded')
...
print(f'inted, voxels count: {len(voxels)}')

mc = Minecraft('192.168.1.77')  # connect to server on localhost

mc.postToChat("Printing 3DBenchy!")
